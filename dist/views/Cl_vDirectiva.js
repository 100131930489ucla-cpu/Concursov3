export class Cl_vDirectiva {
     ...
     */
    mostrarResultadosSimples(aspirantesSimples) {
        if (!this.tablaCuerpo)
            return;
     ...
     */
    renderizerTablaFormatos(aspirantes, notaMasAltaConcurso) {
        if (!this.tablaCuerpo)
            return;
        this.tablaCuerpo.innerHTML = "";
     ...
     */
    calcularPorcentajeCalificacion(aspirantes) {
     ...
     */
    actualizarDestacado(aspirantes, notaMasAltaConcurso) {
        if (!this.seccionDestacados)
            return;
        this.seccionDestacados.innerHTML = "";
        const ganadores = aspirantes.filter((a) => {
...
//# sourceMappingURL=Cl_vDirectiva.js.map