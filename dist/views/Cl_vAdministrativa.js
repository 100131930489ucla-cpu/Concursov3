export class Cl_vAdministrativa {
    ...
    cargarFormulario(data) {
        ...
        const juradoTotal = data.aptitudGlobal ?? data.notaAptitud ?? ((Number(data.crit_1 || data.crit1 || data.matrizJuradoA?.[0] || data.matrizJurado?.[0] || data.jurado?.[0] || 0)) +
        ...
        const totalJuradoWrapper = document.getElementById("totalJuradoWrapper");
        ...
        const chkRequisitos = document.getElementById("chkRequisitos");
        const chkAsistencia = document.getElementById("chkAsistencia");
        if (chkRequisitos)
            chkRequisitos.checked = data.cumpleRequisitos === 1 || data.cumpleRequisitos === "1" || data.cumpleRequisitos === true;
        if (chkAsistencia)
            chkAsistencia.checked = data.sePresento === 1 || data.sePresento === "1" || data.sePresento === true;
    }
