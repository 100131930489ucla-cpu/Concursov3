import { Cl_vAdministrativa } from "../views/Cl_vAdministrativa.js";

export class Cl_cAdministrativa {
  private vista: Cl_vAdministrativa;
  private URL_API = "https://6a18afaf1878294b597d7464.mockapi.io/aspirantes";

  constructor(vista: Cl_vAdministrativa) {
    this.vista = vista;
  ...
  async registrar(e: Event): Promise<void> {
    e.preventDefault();
