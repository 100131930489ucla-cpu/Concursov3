import { IAspirante } from "../interface/I_vAspirante.js";

export class Cl_mAspirante implements IAspirante {
  // Inicialización CO-5
  ...
  // CO-5
  public subCO5_postgradoEspecialidad: number;
  public subCO5_postgradoOtros: number;
  public subCO5_cursosAmpliacion: number;
  public subCO5_reconocimientosTesis: number;
  // CO-5.1
  public subCO51_tituloPromedio: number;
  public subCO51_preparadorAsistente: number;
  public subCO51_actividadOtrasAreas: number;
  public subCO51_diplomaSobresaliente: number;
  public subCO51_diplomaOtros: number;
  public subCO51_reconocimientoInvest: number;
  public subCO51_reconocimientoExt: number;
  // CO-5.2
  public subCO52_librosEditorial: number;
  public subCO52_librosSinEditorial: number;
  public subCO52_articulosArbitradosInd: number;
  public subCO52_articulosArbitradosNoInd: number;
  public subCO52_articulosNoArbitrados: number;
  public subCO52_articulosOtros: number;
  public subCO52_memoriasCongreso: number;
  public subCO52_ponencias: number;
  public subCO52_patentes: number;
  // CO-5.3
  public subCO53_docenciaInvest: number;
  public subCO53_premiosDocencia: number;
  public subCO53_expProfesionalObjeto: number;
  public subCO53_expProfesionalOtras: number;
  public subCO53_premiosProfesionales: number;
  public subCO53_direccionInstitutos: number;
  public subCO53_pasantiasObjeto: number;
  public subCO53_pasantiasOtras: number;

  public notaExamenEscrito: number;
  public notaExamenOralPractico: number;
  public aptitudGlobal: number;
  public postgradoRaw: number;
  public pregradoRaw: number;
  public produccionRaw: number;
  public experienciaRaw: number;
  public matrizJuradoA: number[];
  public matrizJuradoB: number[];
  public matrizJuradoC: number[];
  public cumpleRequisitos: boolean;
  public sePresento: boolean;
  ...
  public porcCO9(): number {
    return this.notaCO10() * 0.30;
  }

  // CO-11: Veredicto Integrado
  public notaDefinitivaCO11(): number {
    if (!this.cumpleRequisitos || !this.sePresento) return 0;
    return this.porcCO7() + this.porcCO8() + this.porcCO9();
  }

  public obtenerVeredictoCO11(notaGanadora: number): string {
    if (!this.cumpleRequisitos) return "No cumple con los requisitos exigidos en la convocatoria.";
    if (!this.sePresento) return "No se presentó al proceso de selección.";
    if (this.notaCO8() < 15) return "No seleccionado en la Prueba de Conocimiento por no alcanzar la nota mínima exigida.";
    
    const notaFinal = this.notaDefinitivaCO11();
    if (notaFinal < 16) return "No seleccionado por no alcanzar la nota mínima aprobatoria en las pruebas.";
    if (notaFinal === notaGanadora && notaFinal >= 16) return "Seleccionado por obtener la mayor calificación.";
